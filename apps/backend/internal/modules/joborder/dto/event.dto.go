...
type JobStatusEventResponse struct {
	...
	RejectionReason *string `json:"rejection_reason" enums:"late_after_final,out_of_order,pending_approval,cancellation_rejected,settlement_pending,settlement_decided" example:"late_after_final"`
