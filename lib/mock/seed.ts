...
/** Dipakai halaman depan sebagai peta demo: tiap skenario di dokumen bisnis
    punya alamat yang bisa diklik, bukan sekadar diceritakan. */
export const SCENARIO_INDEX: Array<{
  ref: string
  title: string
  decision: string
  role: "klien" | "ops" | "lapangan"
}> = [
  {
    ref: "JO-2601",
    title: "Sinyal hilang, tiga pembaruan terkirim sekaligus",
    decision: "B-02, B-06",
    role: "klien",
  },
  {
    ref: "JO-2602",
    title: "Pembaruan terlambat setelah order dibatalkan — ditolak, tetap dicatat",
    decision: "B-07",
    role: "ops",
  },
  {
    ref: "JO-2603",
    title: "Kargo belum tiba di dermaga — Gagal, bukan Dibatalkan",
    decision: "Bagian 7",
    role: "klien",
  },
  {
    ref: "JO-2604",
    title: "Tanpa pembaruan sembilan jam",
    decision: "Bagian 4",
    role: "ops",
  },
  {
    ref: "JO-2605",
    title: "Pembatalan setelah pekerjaan dimulai menjadi permintaan",
    decision: "B-05",
    role: "klien",
  },
  {
    ref: "JO-2606",
    title: "Salah tekan Selesai, dikoreksi koordinator beralasan",
    decision: "B-06, F-06",
    role: "ops",
  },
]
