...
/** Kosakata peran mengikuti backend persis. Menerjemahkannya ke istilah lain di
    sini hanya menciptakan dua kosakata yang bisa menyimpang diam-diam. */
export type Role = "client" | "admin" | "inspector" | "cs"
