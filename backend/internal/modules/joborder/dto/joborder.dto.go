...
type JobOrderResponse struct {
	...
	CurrentStatus   string    `json:"current_status" example:"in_progress"`
...
type CancelResult struct {
	Status  string           `json:"status" example:"cancelled"` // cancelled | pending_approval
	Fee     string           `json:"fee"    example:"travel"`
	Message string           `json:"message"`
	Order   JobOrderResponse `json:"order"`
}
